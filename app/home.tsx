...
import { Award, BookOpen, ChevronRight, Code2, Flame, GitBranch, Globe2, Layout, Layers3, Paintbrush, Palette, Play, Server, Sparkles, Wind } from 'lucide-react-native';
...
function HomeScreen() {
    ...
    const subheadline =
        language === 'ru'
            ? 'JS, TS, React, Node.js, Git, Next.js, Nest.js, MUI, Tailwind — теория и практика.'
            : 'JS, TS, React, Node.js, Git, Next.js, Nest.js, MUI, Tailwind — theory and practice.';
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content} testID="home-screen">
                    <View style={styles.headerRow}>
                        <View style={styles.headerTextWrap}>
                            <Text style={styles.brand}>CODE SPRINT · 70 DAYS</Text>
