...
import { Award, BookOpen, ChevronRight, Code2, Flame, GitBranch, Globe2, Layout, Layers3, Palette, Play, Server, Sparkles, Wind } from 'lucide-react-native';
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content} testID="home-screen">
                    <View style={styles.headerRow}>
                        <View style={styles.headerTextWrap}>
                            <Text style={styles.brand}>DEVELOPER TRAINER · 70 DAYS</Text>
